"use strict";
/**
 * Unit Tests for Mock Forecast Generator
 */
Object.defineProperty(exports, "__esModule", { value: true });
const mockForecast_1 = require("../../src/mockForecast");
describe('Mock Forecast Module', () => {
    describe('generateMockDailyForecast', () => {
        it('should generate correct number of days', () => {
            const result = (0, mockForecast_1.generateMockDailyForecast)('2026-02-11', '2026-02-17', 20);
            expect(result).toHaveLength(7); // 7 days inclusive
        });
        it('should generate forecast for each day in range', () => {
            const result = (0, mockForecast_1.generateMockDailyForecast)('2026-02-11', '2026-02-13', 20);
        ...
        it('should include all required fields', () => {
            const result = (0, mockForecast_1.generateMockDailyForecast)('2026-02-11', '2026-02-11', 20);
        ...
        it('should use provided base temperature', () => {
            const result = (0, mockForecast_1.generateMockDailyForecast)('2026-02-11', '2026-02-11', 30);
    ...
    describe('generateMockHourlyForecast', () => {
        it('should generate 24 hours for single day', () => {
            const result = (0, mockForecast_1.generateMockHourlyForecast)('2026-02-11', '2026-02-11', 20);
            expect(result).toHaveLength(24);
        });
        it('should generate 48 hours for two days', () => {
            const result = (0, mockForecast_1.generateMockHourlyForecast)('2026-02-11', '2026-02-12', 20);
    ...
    describe('generateMockForecast', () => {
        it('should generate hourly forecast for today period', () => {
            const result = (0, mockForecast_1.generateMockForecast)('today', '2026-02-11', '2026-02-12', 20);
            expect(result.length).toBeGreaterThan(0);
            expect(result[0]).toHaveProperty('time'); // Hourly format
        });
        it('should generate daily forecast for week period', () => {
            const result = (0, mockForecast_1.generateMockForecast)('week', '2026-02-11', '2026-02-17', 20);
            expect(result).toHaveLength(7);
            expect(result[0]).toHaveProperty('date'); // Daily format
        });
        it('should generate daily forecast for month period', () => {
            const result = (0, mockForecast_1.generateMockForecast)('month', '2026-02-11', '2026-03-12', 20);
            expect(result).toHaveLength(30);
            expect(result[0]).toHaveProperty('date'); // Daily format
        });
    });
});
//# sourceMappingURL=mockForecast.test.js.map